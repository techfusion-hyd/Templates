(function() {
  ...
  d3.random = {
    normal: function(Ã‚Âµ, ÃÆ’) {
      ...
      return function() {
        ...
        return Ã‚Âµ + ÃÆ’ * x * Math.sqrt(-2 * Math.log(r) / r);
      };
    },
    logNormal: function(Ã‚Âµ, ÃÆ’) {
      var n = arguments.length;
      if (n < 2) ÃÆ’ = 1;
      if (n < 1) Ã‚Âµ = 0;
      var random = d3.random.normal();
      return function() {
        return Math.exp(Ã‚Âµ + ÃÆ’ * random());
      };
    },
  ...
  var d3_formatPrefixes = [ "y", "z", "a", "f", "p", "n", "ÃŽÂ¼", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y" ].map(d3_formatPrefix);
